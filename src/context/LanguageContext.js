...
const translationsData = {
  de: { /* --- tus keys --- */ 
	...
	roomLabel: "Raum", leave: "Verlassen", roomHint: "Erstelle einen Raum oder nimm eine Einladung an.", clear: "Zurücksetzen", reveal: "Ergebnisse anzeigen",
	hide: "Ergebnisse ausblenden", connected: "Verbunden", votes: "Stimmen", inRoom: "Im Raum", voted: "abgestimmt", notVoted: "nicht abgestimmt", inviteTitle: "Raumeinladung", inviteMsg: "lädt dich in den Raum ein", createTitle: "Raum erstellen", createLabel: "Name des Raums", createCta: "Erstellen", cancel: "Abbrechen", joinFirst: "Zuerst einem Raum beitreten/erstellen."
	},
  ...
  en: {
	...
	qp: {lobby: "Lobby", createRoom: "Create room", inviteTo: "Invite to {room}", roomLabel: "Room", leave: "Leave", roomHint: "Create or accept an invitation to join a room.", clear: "Clear", reveal: "Reveal results", hide: "Hide results", connected: "Connected", votes: "Votes", inRoom: "In the room", voted: "voted",
	notVoted: "not voted", inviteTitle: "Room invitation", inviteMsg: "invites you to room", createTitle: "Create room", createLabel: "Room name", createCta: "Create", cancel: "Cancel", joinFirst: "Create/join a room first."},
	user: {createTitle: "Create temporary user",createLabel: "Enter your name to play:",
      confirm: "Start",cancel: "Cancel"}
  },
  es: {
